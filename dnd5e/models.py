...
class Item(models.Model):
    ...
    category = models.CharField(choices=ItemCategory.choices())
...
class Equipment(Item):
    ...
    type = models.CharField(choices=EquipmentType.choices())
...
class Armor(Equipment):
    ...
    armor_slot = models.CharField(choices=ArmorSlot.choices())
    weight_category = models.CharField(choices=ArmorWeightCategory.choices())

class Addon(Equipment):
    addon_id = models.IntegerField(primary_key=True)
    addon_slot = models.CharField(choices=AddonSlot.choices())
